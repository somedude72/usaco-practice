...
std::vector<char> createLine(int lineLength, int multiplier) {
...
int main() {
	...
	int rowNumber, lineLength, multiplier;
	std::cin >> rowNumber >> lineLength >> multiplier;

	for (int i = 0; i < rowNumber; i++) {
		auto line = createLine(lineLength, multiplier);
