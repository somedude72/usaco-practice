...
int main() {
	...
	if (is_corner_covered(lawnmower.x1, lawnmower.y1, cow_feed)) { covered_corners++; }
	if (is_corner_covered(lawnmower.x1, lawnmower.y2, cow_feed)) { covered_corners++; }
	if (is_corner_covered(lawnmower.x2, lawnmower.y2, cow_feed)) { covered_corners++; }
	if (is_corner_covered(lawnmower.x2, lawnmower.y1, cow_feed)) { covered_corners++; }
